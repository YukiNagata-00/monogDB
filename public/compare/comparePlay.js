...
options.forEach(function (element) {
    element.addEventListener("click", function () {
        ...
        if (food1 > food2) {
            larger = questions[index].foodname;
        } else {
            larger = questions[index + 1].foodname;
        }
...
function updateQuestion() {
    ...
    foodName1.innerText = questions[index].foodname;
    foodImg1.src = '/images/foods/' + questions[index].image;
    foodName2.innerText = questions[index + 1].foodname;
